...
function fetchHtml () {
    // fetch returns Object called promise with method then
...
function currConvert(e) {
    ...
    fetch(`https://free.currencyconverterapi.com/api/v6/convert?q=${currKey}&compact=ultra&apiKey=c57098dde5f2c88d077d`)
        .then( response => response.json() )
        .then( currency => {
